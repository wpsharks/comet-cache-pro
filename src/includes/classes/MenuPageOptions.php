    ...
    public function __construct()
    {
        ...
        if (IS_PRO || $this->plugin->isProPreview()) {
            ...
            if (is_multisite()) {
                ...
                echo '      <p style="margin-top:0;">'.sprintf(__('<strong>Note:</strong> As a security measure, in addition to the Role(s) and/or Capabilities that you list here, each child site owner must also have the ability to <code>%1$s</code>.', SLUG_TD), esc_html($this->plugin->cap)).'</p>'."\n";
                echo '      </select></p>'."\n";
                echo '  </div>'."\n";
            }
