...
class MenuPageOptions extends MenuPage
{
    ...
    public function __construct()
    {
        ...
        if (IS_PRO || $this->plugin->isProPreview()) {
            ...
            echo '      <p>'.__('Most sites will NOT want Static CDN Filters applied when a user is logged-in. Content for logged-in users is often very dynamic and rewriting static resource URLs for logged-in users can cause problems. However, if you know that your logged-in user content is very static, please choose: <code>Yes, enable Static CDN Filters for logged-in users</code> to improve performance.', SLUG_TD).'</p>'."\n";
