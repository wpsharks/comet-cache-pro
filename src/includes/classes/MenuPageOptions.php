...
class MenuPageOptions extends MenuPage
{
    ...
    public function __construct()
    {
        ...
        if (IS_PRO || $this->plugin->isProPreview()) {
            ...
            echo '      <p>'.__('A common choice among sites is to disable Static CDN filters when a user is logged-in to avoid causing an issue, as this content for logged-in users is often very dynamic and rewrites static resource URLs. However, if you know that your logged-in user content is static, please choose: <code>Yes, enable Static CDN Filters for logged-in users</code> to improve performance.', SLUG_TD).'</p>'."\n";
