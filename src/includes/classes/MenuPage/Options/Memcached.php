...
class Memcached extends Classes\AbsBase
{
    ...
    public function __construct()
    {
        ...
        if (IS_PRO || $this->plugin->isProPreview()) {
            ...
            echo '      <p class="info">'.__('<strong>Logged-In Users:</strong> User-specific cache entries for logged-in users are not stored in RAM. Memcached works to enhance speed for non-logged-in users only at this time.', SLUG_TD).'</p>'."\n";
