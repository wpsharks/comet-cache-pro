...
${__FILE__}['version'] = '160103'; //version//
...
define(__NAMESPACE__.'\\SHORT_NAME', 'IC');
define(__NAMESPACE__.'\\NAME', 'IntelliCache');
define(__NAMESPACE__.'\\DOMAIN', 'intellicache.me');
define(__NAMESPACE__.'\\GLOBAL_NS', 'intellicache');
define(__NAMESPACE__.'\\SLUG_TD', 'intellicache');
