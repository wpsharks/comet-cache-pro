...
if (!defined(__NAMESPACE__.'\\CACHE_PATH_DEFAULT')) {
     ...
     * @type int A bitmask.
     */
    define(__NAMESPACE__.'\\CACHE_PATH_DEFAULT', 0);
     ...
     */
    define(__NAMESPACE__.'\\CACHE_PATH_NO_SCHEME', 1);
     ...
     * @type int Part of a bitmask.
     */
    define(__NAMESPACE__.'\\CACHE_PATH_NO_HOST', 2);
     ...
     * @type int Part of a bitmask.
     */
    define(__NAMESPACE__.'\\CACHE_PATH_NO_PATH', 4);
     ...
     * @type int Part of a bitmask.
     */
    define(__NAMESPACE__.'\\CACHE_PATH_NO_PATH_INDEX', 8);
     ...
     * @type int Part of a bitmask.
     */
    define(__NAMESPACE__.'\\CACHE_PATH_NO_QUV', 16);
     ...
     * @type int Part of a bitmask.
     */
    define(__NAMESPACE__.'\\CACHE_PATH_NO_QUERY', 32);
     ...
     * @type int Part of a bitmask.
     */
    define(__NAMESPACE__.'\\CACHE_PATH_NO_USER', 64);
     ...
     * @type int Part of a bitmask.
     */
    define(__NAMESPACE__.'\\CACHE_PATH_NO_VSALT', 128);
     ...
     * @type int Part of a bitmask.
     */
    define(__NAMESPACE__.'\\CACHE_PATH_NO_EXT', 256);
     ...
     * @type int Part of a bitmask.
     */
    define(__NAMESPACE__.'\\CACHE_PATH_ALLOW_WILDCARDS', 512);
     ...
     */
    define(__NAMESPACE__.'\\CACHE_PATH_REGEX_DEFAULT_SUFFIX_FRAG', '(?:\/index)?(?:\.|\/(?:page\/[0-9]+|comment\-page\-[0-9]+)[.\/])');
}
