	...
	if(!class_exists('\\'.__NAMESPACE__.'\\plugin'))
	{
		...
		class plugin extends share
		{
			...
			public function wipe_htmlc_cache($manually = FALSE)
			{
				...
				$cache_dir_public  = $this->wp_content_base_dir_to($this->htmlc_cache_sub_dir_public);
				$cache_dir_private = $this->wp_content_base_dir_to($this->htmlc_cache_sub_dir_private);
