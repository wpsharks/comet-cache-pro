...
namespace quick_cache // Root namespace.
{
	...
	class menu_pages // Plugin options.
	{
		...
		public function options()
		{
			...
			echo '            <option value="1"'.selected($this->plugin->options['cache_purge_home_page_enable'], '1', FALSE).'>'.__('Yes, if any single Post/Page is purged/reset; also purge the "Home Page".', $this->plugin->text_domain).'</option>'."\n";
			echo '            <option value="0"'.selected($this->plugin->options['cache_purge_home_page_enable'], '0', FALSE).'>'.__('No, my Home Page does not provide a list of Posts/Pages; e.g. this is not necessary.', $this->plugin->text_domain).'</option>'."\n";
			echo '         </select></p>'."\n";
			...
			echo '            <option value="1"'.selected($this->plugin->options['cache_purge_author_page_enable'], '1', FALSE).'>'.__('Yes, if any single Post/Page is purged/reset; also purge the "Author Page".', $this->plugin->text_domain).'</option>'."\n";
			echo '            <option value="0"'.selected($this->plugin->options['cache_purge_author_page_enable'], '0', FALSE).'>'.__('No, my site doesn\'t use multiple authors and/or I don\'t have any "Author Page" archive views.', $this->plugin->text_domain).'</option>'."\n";
			echo '         </select></p>'."\n";
			...
			echo '            <option value="1"'.selected($this->plugin->options['cache_purge_term_category_enable'], '1', FALSE).'>'.__('Yes, if any single Post/Page is purged/reset; also purge the associated Category archive views.', $this->plugin->text_domain).'</option>'."\n";
			echo '            <option value="0"'.selected($this->plugin->options['cache_purge_term_category_enable'], '0', FALSE).'>'.__('No, my site doesn\'t use Categories and/or I don\'t have any Category archive views.', $this->plugin->text_domain).'</option>'."\n";
			echo '         </select></p>'."\n";
			...
			echo '            <option value="1"'.selected($this->plugin->options['cache_purge_term_post_tag_enable'], '1', FALSE).'>'.__('Yes, if any single Post/Page is purged/reset; also purge the associated Tag archive views.', $this->plugin->text_domain).'</option>'."\n";
			echo '            <option value="0"'.selected($this->plugin->options['cache_purge_term_post_tag_enable'], '0', FALSE).'>'.__('No, my site doesn\'t use Tags and/or I don\'t have any Tag archive views.', $this->plugin->text_domain).'</option>'."\n";
			echo '         </select></p>'."\n";
			...
			echo '            <option value="1"'.selected($this->plugin->options['cache_purge_custom_post_type_enable'], '1', FALSE).'>'.__('Yes, if any single Post with a Custom Post Type is purged/reset; also purge any associated Custom Post Type archive views.', $this->plugin->text_domain).'</option>'."\n";
			echo '            <option value="0"'.selected($this->plugin->options['cache_purge_custom_post_type_enable'], '0', FALSE).'>'.__('No, my site doesn\'t use any Custom Post Types and/or I don\'t have any Custom Post Type archive views.', $this->plugin->text_domain).'</option>'."\n";
			echo '         </select></p>'."\n";
			echo '      <hr />'."\n";
