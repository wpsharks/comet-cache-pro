			...
			public function options()
				{
					...
					echo '      <table style="width:100%;"><tr><td style="width:1px; font-weight:bold; white-space:nowrap;">$_SERVER[\'HTTPS\'].$_SERVER[\'HTTP_HOST\'].$_SERVER[\'REQUEST_URI\'].</td><td><input type="text" name="'.esc_attr(__NAMESPACE__).'[save_options][version_salt]" value="'.esc_attr(plugin()->options['version_salt']).'" class="monospace" /></td><td style="width:1px; font-weight:bold; white-space:nowrap;"></td></tr></table>'."\n";
